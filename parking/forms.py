...
USERNAME_HELP_TEXT = 'حروف و اعداد انگلیسی، حداقل یک حرف انگلیسی، حداکثر ۶۰ کاراکتر.'
USERNAME_ERROR_MESSAGES = {
    'required': 'نام کاربری را وارد کنید.',
    'invalid': 'نام کاربری حداقل یک حرف انگلیسی داشته باشد و فقط از حروف و اعداد انگلیسی تشکیل شود.',
